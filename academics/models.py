...
class Person(models.Model):
    ...
    id_ident_type = models.ForeignKey('Identification_types', on_delete=models.CASCADE, blank = False, blank = False)
    ident_number = models.CharField(max_length = 12, blank = False)
    id_exp_city = models.ForeignKey( 'Cities', on_delete = models.CASCADE, blank = False, blank = False)
...
class Students(models.Model):
    code = models.models.CharField(max_length=50, blank = True)
    id_person = models.ForeignKey('Person', on_delete = models.CASCADE, blank = False)
    status = models.models.BooleanField(default = True)
...
class Cities(models.Model):
    ...
    id_dept = models.models.ForeignKey("Departaments", on_delete = models.CASCADE, blank = False)
    created_at = models.DateTimeField(default = datetime.datetime.now())
    updated_at = models.DateTimeField(default = datetime.datetime.now())
    deleted_at = models.DateTimeField(null =True, blank = True)
...
class Departaments(models.Model):
    ...
    abrev = models.CharField(max_length = 10, blank = False)
    descript =  models.CharField(max_length = 10, blank = False)
    id_country = models.models.ForeignKey("Countries", on_delete = models.CASCADE, blank = False)
    created_at = models.DateTimeField(default = datetime.datetime.now())
    updated_at = models.DateTimeField(default = datetime.datetime.now())
    deleted_at = models.DateTimeField(null =True, blank = True)
